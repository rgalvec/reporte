...
#C:\Users\rgalv\Nextcloud\2023\web\GitHub\repor_prensa\reporte
```
...
\centering
![]("C:/Users/rgalv/Nextcloud/R/Titulares/Titulares/Resultados/nube_palabras/figura/fig_1.pdf"){width=50%}
...
tabla_med_nac_print <- tabla_med_nac |> 
  left_join(tabla_filtro, by="Titular") |> 
  filter(is.na(Medio.y)) |> 
  rename( Medio = Medio.x) |> 
